...
function addToRanking(time) {
  ...
  if (ranking.length > 10) {
    ranking = ranking.slice(0, 10); // Mantém apenas os 10 maiores tempos
  }
...
// Na função mousePressed(), após calcular o tempo, chame a função addToRanking()
// para adicionar o tempo ao ranking.

// Chame a função loadRanking() na função setup() para carregar o ranking do armazenamento local.
